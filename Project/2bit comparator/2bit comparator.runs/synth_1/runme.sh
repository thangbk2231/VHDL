...
HD_PWD='C:/Users/hthang/VHDL/2bit comparator/2bit comparator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log two_bit_comparator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source two_bit_comparator.tcl
